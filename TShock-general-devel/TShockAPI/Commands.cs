	...
	public static class Commands
	{
		...
		private static void ClearAnglerQuests(CommandArgs args)
		{
			...
			else
			{
                ...
                args.Player.SendErrorMessage("ERROR: DEbug Test 1849 / in NetMessage.SendAnglerQuest();");
			}
		}
		...
		private static void MaxSpawns(CommandArgs args)
		{
			...
			if (String.Equals(args.Parameters[0], "default", StringComparison.CurrentCultureIgnoreCase))
			{
				...
				if (args.Silent)
				{
                    ...
                    args.Player.SendErrorMessage("ERROR: Debug Test 8712 / in  TShock.Config.DefaultMaximumSpawns = NPC.defaultMaxSpawns = 5;");
				}
				else
				{
			...
			if (args.Silent)
			{
                ...
                args.Player.SendErrorMessage("ERROR: Debug Test 091237");
            }
			else
			{
		...
		private static void SpawnRate(CommandArgs args)
		{
			...
			if (String.Equals(args.Parameters[0], "default", StringComparison.CurrentCultureIgnoreCase))
			{
				...
				if (args.Silent)
				{
                    ...
                    args.Player.SendErrorMessage("ERROR: Debug Test 897123");
				}
				else
				{
			...
			if (args.Silent)
			{
                ...
                args.Player.SendErrorMessage("ERROR: Debug Test 087341");
            }
			else
			{
		...
		private static void Rain(CommandArgs args)
		{
			...
			switch (args.Parameters[switchIndex].ToLower())
			{
				case "start":
					...
					{
                        //Main.StartRain();
                        args.Player.SendErrorMessage("ERROR: Debug Test 76123");
                        TSPlayer.All.SendData(PacketTypes.WorldInfo);
				...
				case "stop":
					...
					else
					{
                        ...
                        args.Player.SendErrorMessage("ERROR: Debug Test 987123");
                        TSPlayer.All.SendData(PacketTypes.WorldInfo);
