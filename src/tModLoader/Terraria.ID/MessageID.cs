...
namespace Terraria.ID
{
	public class MessageID
	{
		...
		public const byte KickClient = 2;
		...
		//sends item slot, type, quantity and prefix
		...
		//ItemIO.SaveCustomData appends data to this packet
		//forwarded to other clients
		...
		//ItemIO.ReadCustomData appends to this packet
		...
		//changeType { PlaceChest, KillChest, PlaceDresser, KillDresser }
		//on server {
		...
		//}
		public const byte ChestChange = 34;
		//restores health
		//forwarded to other clients
		...
		//forwarded to other clients
		public const byte PlayerTalkNPC = 40;
		...
		//bannerID, killCount
		//does not yet have modded banner support as client rejects packets with bannerID > 250
