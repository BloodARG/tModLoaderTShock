...
namespace Terraria.ID
{
	public class ProjectileID
	{
		public static class Sets
		{
			...
			public static float[] YoyosLifeTimeMultiplier = ProjectileID.Sets.Factory.CreateFloatSet(-1f, new float[]
				{
					541f,
					3f,
					548f,
			...
			public static float[] YoyosMaximumRange = ProjectileID.Sets.Factory.CreateFloatSet(200f, new float[]
				{
					541f,
					130f,
					548f,
			...
			public static float[] YoyosTopSpeed = ProjectileID.Sets.Factory.CreateFloatSet(10f, new float[]
				{
					541f,
					9f,
					548f,
			...
			public static bool[] CanDistortWater = ProjectileID.Sets.Factory.CreateBoolSet(true, new int[]
				{
					7,
					8,
					152,
			...
			static Sets()
			{
				...
				SetFactory arg_A43_0 = ProjectileID.Sets.Factory;
				int arg_A43_1 = -1;
				...
				array[95] = 2;
				array[96] = 712;
				ProjectileID.Sets.TrailingMode = arg_A43_0.CreateIntSet(arg_A43_1, array);
				ProjectileID.Sets.TrailCacheLength = ProjectileID.Sets.Factory.CreateIntSet(10, new int[]
					{
						466,
						20,
						502,
				...
				ProjectileID.Sets.LightPet = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
					{
						18,
						500,
						72,
				...
				ProjectileID.Sets.Homing = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
					{
						207,
						182,
						247,
				...
				ProjectileID.Sets.IsADD2Turret = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
					{
						663,
						665,
						667,
				...
				ProjectileID.Sets.TurretFeature = ProjectileID.Sets.Factory.CreateBoolSet(new int[0]);
				ProjectileID.Sets.MinionTargettingFeature = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
					{
						191,
						192,
						193,
				...
				ProjectileID.Sets.MinionSacrificable = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
					{
						191,
						192,
						193,
				...
				ProjectileID.Sets.DontAttachHideToAlpha = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
					{
						598,
						641,
						617,
				...
				ProjectileID.Sets.NeedsUUID = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
					{
						625,
						626,
						627,
				...
				ProjectileID.Sets.StardustDragon = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
					{
						625,
						626,
						627,
				...
				ProjectileID.Sets.NoLiquidDistortion = ProjectileID.Sets.Factory.CreateBoolSet(new int[]
					{
						511,
						512,
						513
