		...
		public static void addCloud()
		{
			...
			if (num >= 0)
			{
				...
				if ((Main.cloudAlpha > 0f && Cloud.rand.Next(4) != 0) || (Main.cloudBGActive >= 1f && Cloud.rand.Next(2) == 0))
				{
					...
					{
						Cloud expr_2F2_cp_0 = Main.cloud[num];
						expr_2F2_cp_0.position.Y = expr_2F2_cp_0.position.Y - 150f;
					}
					if (Main.cloud[num].scale >= 1f)
					{
						Cloud expr_325_cp_0 = Main.cloud[num];
						expr_325_cp_0.position.Y = expr_325_cp_0.position.Y - 150f;
					}
				}
				...
				{
					Cloud expr_4F9_cp_0 = Main.cloud[num];
					expr_4F9_cp_0.position.Y = expr_4F9_cp_0.position.Y + 100f;
				}
